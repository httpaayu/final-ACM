...
const firebaseConfig = {
      apiKey: "AIzaSyDWqiOubarIl64i2qeoJsh3-3WZKDt9BLc",
  authDomain: "final-acm-30af1.firebaseapp.com",
  projectId: "final-acm-30af1",
  storageBucket: "final-acm-30af1.firebasestorage.app",
  messagingSenderId: "644266603050",
  appId: "1:644266603050:web:084fce9d5ba53e71120953",
  measurementId: "G-D9J6XYF8ME"
};
...
function loadEvents() {
    ...
    db.collection("events").orderBy("date", "asc").get().then((querySnapshot) => {
        ...
        if (querySnapshot.empty) {
            eventsGrid.innerHTML = "<p>No events found. Stay tuned!</p>";
            return;
        }
            ...
            const eventHTML = `
                <div class="event-card">
                    ...
                    <div class="event-content">
                        ...
                        <button class="event-btn">${event.buttonText || "Register"}</button>
                    </div>
                </div>
            `;
...
console.log('🚀 ACM Tula\'s Website Loaded Successfully!');
console.log('💻 Built with passion for the hackathon');
